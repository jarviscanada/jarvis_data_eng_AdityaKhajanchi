...
I am a curious and enthusiastic Business Systems Analyst with strong communication and collaboration skills. I enjoy taking on new challenges and solving business problems that drive meaningful impact and support organizational goals. Presently at Jarvis, I am applying cloud, big data, analytics, and business systems analysis skills to deliver simulated banking and financial services projects that mirror real-world challenges. Across my academic and professional experiences, I have contributed to cross-functional projects through leadership, stakeholder engagement, and adaptability in dynamic and fast-paced environments.

## Skills

**Proficient:** SQL, PowerBI, Tableau, Excel, PowerQuery, Reporting, Presentations, Git

**Competent:** Agile/Scrum, Waterfall, Python, Databricks, Hadoop, Spark/PySpark, MS SQL Server, ETL, Looker, Visio, Azure AI Services, GIS Data, Trello, UML Diagrams, Documentation

**Familiar:** R, Snowflake, JIRA, OpenCV, Firebase, JAVA, MS Project, Technical Writing
...
**PySpark Big Data Analytics: Databricks & Hadoop/Zeppelin Evaluation** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_AdityaKhajanchi/tree/master/spark)]: Developed a scalable big data analytics solution by re-architecting a single-node Python/Jupyter setup to Apache Spark cluster environments. Implemented retail customer analytics, including Recency-Frequency-Monetary (RFM) segmentation, on Azure Databricks using DBFS, Hive Metastore, and Spark Structured APIs (DataFrames, SQL). Evaluated Spark performance in a Hadoop ecosystem by deploying World Development Indicators (WDI) dataset on GCP Dataproc clusters with HDFS, Hive, and Zeppelin notebooks, analyzing GDP trends across countries. Explored Spark internals (jobs, stages, partitions, Catalyst optimizer) and demonstrated distributed computing advantages by comparing Databricks and Hadoop/Zeppelin implementations. Delivered reproducible notebooks, architecture diagrams, highlighting cloud-based scalability, structured APIs, and practical big data processing workflows.

**Hadoop Big Data Analytics Project: Setup and Query Optimization** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_AdityaKhajanchi/tree/master/hadoop)]: Implemented a scalable Hadoop cluster on Google Cloud Platform (1 master, 2 worker nodes) to assess Hadoop as an alternative to legacy analytics tools such as SAP and R. Designed and tested distributed storage and processing using HDFS, YARN, and Hive, with interactive analysis in Zeppelin notebooks. Conducted performance benchmarking on a 1TB stock trades dataset, demonstrating how distributed computing reduced execution times from hours to minutes. Optimized Hive queries with year-based partitions, Parquet storage (reducing size from 1.7 GB to 263 MB), and the Tez engine, improving query speeds by up to 45x. Explored MapReduce, Tez, and HiveQL for analytics while comparing imperative and declarative SQL approaches in distributed environments.

**Power BI Dashboard Suite: Sales, Survey & Financial Visualizations** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_AdityaKhajanchi/tree/master/power_bi)]: Developed three interactive Power BI dashboards in retail, HR, and financial analytics, incorporating advanced data modeling, DAX measures, real-time integrations, and APIs. The projects included a Beverages Sales Dashboard analyzing Coca-Cola product performance with KPIs, geographic insights, and key influencer analysis; a Data Professionals Survey Report visualizing workforce trends from 630 respondents using diverse visual formats; and a Stocks Dashboard leveraging Alpha Vantage API for live market tracking with candlestick charts, key ratios, and dynamic visuals. Each dashboard was designed for decision-makers with a focus on clarity, interactivity, and actionable insights.

**Customer Analytics and RFM Segmentation for LGS (PoC)** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_AdityaKhajanchi/tree/master/python_data_analytics)]: Designed a system architecture diagram mapping the end-to-end data flow for London Gift Shop (LGS), from raw CSV ingestion to processed insights and dashboard outputs, enabling scalable retail analysis. Developed a Python-based proof of concept for data cleaning, preprocessing, and exploratory analysis using pandas, NumPy, and visualization tools including Matplotlib, Seaborn, Plotly, and Folium. Implemented logic to handle null values, correct data types, and enrich data by mapping countries to continents. Created interactive charts to highlight sales trends, regional patterns, and customer behavior, and built a Recency-Frequency-Monetary (RFM) matrix for customer segmentation and targeted marketing.
...
**SQL Project: Database Design & Advanced Querying** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_AdityaKhajanchi/tree/master/sql)]: Developed a PostgreSQL-based SQL project to strengthen core and advanced SQL skills, covering DDL, DML, DQL, joins, subqueries, aggregates, string manipulation, and window functions. Designed a sample relational database with three linked tables (members, facilities, bookings) in a Dockerized PostgreSQL environment. Completed hands-on exercises such as modifying data, generating insights through complex queries, ranking with window functions, and analyzing monthly booking trends and top facility usage. Applied real-world scenarios like member recommendations and booking pattern analysis while reinforcing query optimization, data transformation, and PostgreSQL function expertise.
