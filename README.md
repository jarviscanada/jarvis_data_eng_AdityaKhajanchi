...
**PySpark Big Data Analytics: Databricks & Hadoop/Zeppelin Evaluation** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_AdityaKhajanchi/tree/master/spark)]: Re-architected a single-node Python/Jupyter analytics solution to scalable Apache Spark clusters. Performed retail customer analytics with RFM segmentation on Azure Databricks (DBFS, Hive Metastore, DataFrames/SQL). Evaluated Spark on Hadoop via WDI dataset on GCP Dataproc with HDFS, Hive, and Zeppelin, analyzing GDP trends. Explored Spark internals (jobs, stages, partitions, Catalyst optimizer) and demonstrated distributed computing benefits. Delivered reproducible notebooks and architecture diagrams, highlighting cloud scalability and structured API workflows.
